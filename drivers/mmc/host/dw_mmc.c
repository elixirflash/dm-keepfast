...
#ifdef CONFIG_MMC_POLLING_WAIT_CMD23 //yongja			
...
#ifdef CONFIG_MMC_CACHE_CONTROL	
		mmc->caps2 |= MMC_CAP2_CACHE_CTRL;
#endif
#ifdef CONFIG_MMC_PACKED_COMMANDS		
		mmc->caps2 |= MMC_CAP2_PACKED_CMD;
#endif
#ifdef CONFIG_MMC_POWEROFF_NOTIFY
...
#if 1	//yongja
	printk (KERN_INFO "[%s] ===========================================================\n", __func__);
	printk (KERN_INFO "### pdata->hclk_name : %s###\n", host->pdata->hclk_name);
	printk (KERN_INFO "hclk name : %s\n", host->hclk->devname);
	printk (KERN_INFO "hclk rate : %ld\n", clk_get_rate(host->hclk));
	printk (KERN_INFO "hclk parant clk name : %s\n", host->hclk->parent->name);
	printk (KERN_INFO "hclk parant clk : %ld\n", clk_get_rate(host->hclk->parent));
	printk (KERN_INFO "hclk parant2 clk name : %s\n", host->hclk->parent->parent->name);
	printk (KERN_INFO "hclk parant2 clk : %ld\n", clk_get_rate(host->hclk->parent->parent));
	printk (KERN_INFO "[%s] -----------------------------------------------------------\n", __func__);
#endif	
	if (IS_ERR(host->hclk)) {
		dev_err(&pdev->dev,
...
#if 1
	printk (KERN_INFO "###pdata->cclk_name : %s###\n", host->pdata->cclk_name);
	printk (KERN_INFO "cclk name : %s\n", host->cclk->devname);
	printk (KERN_INFO "cclk rate : %ld\n", clk_get_rate(host->cclk));
	printk (KERN_INFO "cclk parant clk name : %s\n", host->cclk->parent->name);
	printk (KERN_INFO "cclk parant clk : %ld\n", clk_get_rate(host->cclk->parent));
	printk (KERN_INFO "cclk parant2 clk name : %s\n", host->cclk->parent->parent->name);
	printk (KERN_INFO "cclk parant2 clk : %ld\n", clk_get_rate(host->cclk->parent->parent));
	printk (KERN_INFO "[%s] ===========================================================\n", __func__);
#endif	
	if (IS_ERR(host->cclk)) {
		dev_err(&pdev->dev,
...
static int __devinit dw_mci_init(void)
{
...
device_initcall_sync(dw_mci_init);
