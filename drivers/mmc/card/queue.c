...
#if 1 //yongja
	printk (KERN_INFO "[%s]\n"
						"q_segment_boundary : %lu, q->max_sectors : %u, q_max_hw_sectors : %u\n"
						"q_max_segments : %u, q_max_segment_size : %u, q_logical_block_size : %u\n"
						"q_max_discard_sectors : %u",
						__func__,
						queue_segment_boundary(mq->queue),
						queue_max_sectors(mq->queue),
						queue_max_hw_sectors(mq->queue),
						queue_max_segments(mq->queue), 
						queue_max_segment_size(mq->queue),
						queue_logical_block_size(mq->queue),
